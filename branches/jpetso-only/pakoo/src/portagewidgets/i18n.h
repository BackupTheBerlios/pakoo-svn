...
#ifndef PORTAGEWIDGETS_I18N_H
#define PORTAGEWIDGETS_I18N_H

#include <klocale.h>

// TreeView stuff
#define ALLPACKAGESTEXT i18n("Caption text where all packages are shown (used in tree view and search filter combobox)", "All Packages")
